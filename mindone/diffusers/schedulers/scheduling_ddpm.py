...
class DDPMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def _get_variance(
        self,
        t: int,
        predicted_variance: Optional[ms.Tensor] = None,
        ...
        Args:
            ...
            predicted_variance (`ms.Tensor`, *optional*):
    ...
    def _threshold_sample(self, sample: ms.Tensor) -> ms.Tensor:
        ...
        abs_sample = sample.abs()  # "a certain percentile absolute pixel valu
    ...
    def step(
        ...
        if t > 0:
            ...
            if self.variance_type == "fixed_small_log":
                ...
                variance = mint.exp(0.5 * variance).to(dtype) * variance_noise
            else:
