...
class HunyuanVideoCausalConv3d(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class HunyuanVideoUpsampleCausal3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
...
class HunyuanVideoDownsampleCausal3D(nn.Cell):
    def __init__(
        self,
        channels: int,
        out_channels: Optional[int] = None,
...
class HunyuanVideoResnetBlockCausal3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: Optional[int] = None,
...
class HunyuanVideoMidBlock3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        dropout: float = 0.0,
...
class HunyuanVideoDownBlock3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class HunyuanVideoUpBlock3D(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class HunyuanVideoEncoder3D(nn.Cell):
    r"""
...
class HunyuanVideoDecoder3D(nn.Cell):
    r"""
