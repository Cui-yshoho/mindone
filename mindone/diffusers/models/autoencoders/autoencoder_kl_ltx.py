...
from ...utils.mindspore_utils import randn
...
class LTXVideoCausalConv3d(nn.Cell):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class LTXVideoResnetBlock3d(nn.Cell):
    r"""
    ...
    def construct(
        self, inputs: ms.Tensor, temb: Optional[ms.Tensor] = None, generator: Optional[np.random.Generator] = None
    ) -> ms.Tensor:
...
class LTXVideoDownBlock3D(nn.Cell):
    r"""
...
class LTXVideoMidBlock3d(nn.Cell):
    r"""
...
class LTXVideoUpBlock3d(nn.Cell):
    r"""
...
class LTXVideoEncoder3d(nn.Cell):
    r"""
...
class LTXVideoDecoder3d(nn.Cell):
    r"""
    ...
    def construct(self, hidden_states: ms.Tensor, temb: Optional[ms.Tensor] = None) -> ms.Tensor:
        ...
        if self.time_embedder is not None:
            ...
            temb = unflatten(temb.view(hidden_states.shape[0], -1, 1, 1, 1), 1, (2, -1))
...
class AutoencoderKLLTXVideo(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def _decode(
        self, z: ms.Tensor, temb: Optional[ms.Tensor] = None, return_dict: bool = False
    ...
    def tiled_decode(
        self, z: ms.Tensor, temb: Optional[ms.Tensor], return_dict: bool = False
    ) -> Union[DecoderOutput, ms.Tensor]:
        r"""
