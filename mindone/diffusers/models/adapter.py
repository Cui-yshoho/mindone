...
class MultiAdapter(ModelMixin):
    ...
    def __init__(self, adapters: List["T2IAdapter"]):
        ...
        self.adapters = nn.CellList(adapters)
    ...
    def construct(self, xs: ms.Tensor, adapter_weights: Optional[List[float]] = None) -> List[ms.Tensor]:
        r"""
        Args:
            xs (`ms.Tensor`):
    ...
    def from_pretrained(cls, pretrained_model_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        Args:
            ...
            mindspore_dtype (`str` or `ms.Ttype`, *optional*):
                Override the default `ms.Type` and load the model under this dtype. If `"auto"` is passed the dtype
...
class FullAdapterXL(nn.Cell):
    ...
    def __init__(
        ...
        self.body = nn.CellList(self.body)
...
class AdapterResnetBlock(nn.Cell):
    r"""
...
class LightAdapterBlock(nn.Cell):
    r"""
...
class LightAdapterResnetBlock(nn.Cell):
    """
