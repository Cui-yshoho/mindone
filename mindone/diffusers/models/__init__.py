...
_import_structure = {
    ...
    "autoencoders.autoencoder_kl_hunyuanimage": ["AutoencoderKLHunyuanImage"],
    "autoencoders.autoencoder_kl_hunyuanimage_refiner": ["AutoencoderKLHunyuanImageRefiner"],
    ...
    "autoencoders.autoencoder_kl_qwenimage": ["AutoencoderKLQwenImage"],
    ...
    "transformers.transformer_hunyuanimage": ["HunyuanImageTransformer2DModel"],
