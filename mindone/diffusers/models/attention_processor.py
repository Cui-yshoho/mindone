...
class StableAudioAttnProcessor2_0:
    ...
    def apply_partial_rotary_emb(
        ...
        out = ops.cat((x_rotated, x_unrotated), axis=-1)
        return out
    ...
    def __call__(
        ...
        hidden_states = _scaled_dot_product_attention(query, key, value, attn_mask=attention_mask)
...
def _scaled_dot_product_attention(query, key, value, attn_mask=None, dtype=None):
