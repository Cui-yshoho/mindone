...
class ModularPipeline(ConfigMixin, PushToHubMixin):
    ...
    def to(self, *args, **kwargs) -> Self:
        ...
        > [!TIP] > If the pipeline already has the correct ms.Type, then it is returned as is.
        Otherwise, > the returned pipeline is a copy of self with the desired ms.Type.
