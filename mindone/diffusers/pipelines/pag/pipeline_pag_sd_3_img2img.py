...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import mindspore as ms
        >>> from mindone.diffusers import StableDiffusion3PAGImg2ImgPipeline
        ...
        >>> image = pipe(prompt, image=init_image, guidance_scale=5.0, pag_scale=0.7)[0][0]
        ```
"""
...
class StableDiffusion3PAGImg2ImgPipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin, PAGMixin):
    ...
    def prepare_latents(self, image, timestep, batch_size, num_images_per_prompt, dtype, generator=None):
        ...
        latents = init_latents.to(dtype=dtype)
