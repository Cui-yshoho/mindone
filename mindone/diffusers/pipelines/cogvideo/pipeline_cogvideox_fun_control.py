...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ...     "alibaba-pai/CogVideoX-Fun-V1.1-5b-Pose", mindspore_dtype=ms.bfloat16
        ... )
...
class CogVideoXFunControlPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    def encode_prompt(
        ...
        Args:
            ...
            num_videos_per_prompt (`int`, *optional*, defaults to 1):
                Number of videos that should be generated per prompt. device to place the resulting embeddings on
    ...
    # Adapted from https://github.com/aigc-apps/CogVideoX-Fun/blob/2a93e5c14e02b2b5921d533fd59fc8c0ed69fb24/cogvideox/pipeline/pipeline_cogvideox_control.py#L366  # noqa: E501
    def prepare_control_latents(
        self, mask: Optional[ms.Tensor] = None, masked_image: Optional[ms.Tensor] = None
    ...
    def __call__(
        ...
        control_video_latents: Optional[ms.Tensor] = None,
        prompt_embeds: Optional[ms.Tensor] = None,
        negative_prompt_embeds: Optional[ms.Tensor] = None,
        output_type: str = "pil",
        ...
        Args:
            ...
            control_video_latents (`ms.Tensor`, *optional*):
        ...
        num_frames = len(control_video[0]) if control_video is not None else control_video_latents.shape[2]
