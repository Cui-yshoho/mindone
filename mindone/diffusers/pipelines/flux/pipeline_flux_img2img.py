...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from mindone.diffusers import FluxImg2ImgPipeline
        >>> from mindone.diffusers.utils import load_image

        >>> pipe = FluxImg2ImgPipeline.from_pretrained("black-forest-labs/FLUX.1-schnell", mindspore_dtype=ms.bfloat16)
...
# Copied from mindone.diffusers.pipelines.flux.pipeline_flux.calculate_shift
def calculate_shift(
    image_seq_len,
...
class FluxImg2ImgPipeline(DiffusionPipeline, FluxLoraLoaderMixin, FromSingleFileMixin, FluxIPAdapterMixin):
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline._get_t5_prompt_embeds
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline._get_clip_prompt_embeds
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt: Union[str, List[str]],
    ...
    @staticmethod
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline._prepare_latent_image_ids
    ...
    @staticmethod
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline._pack_latents
    ...
    @staticmethod
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline._unpack_latents
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline.enable_vae_slicing
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline.disable_vae_slicing
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline.enable_vae_tiling
    ...
    # Copied from mindone.diffusers.pipelines.flux.pipeline_flux.FluxPipeline.disable_vae_tiling
    ...
    def __call__(
        ...
        if lora_scale is not None:
            ...
            self.joint_attention_kwargs["scale"] = lora_scale
