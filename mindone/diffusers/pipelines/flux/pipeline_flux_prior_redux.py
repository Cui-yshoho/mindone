...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ...     repo_base, text_encoder=None, text_encoder_2=None, mindspore_dtype=ms.bfloat16
        ... )
...
class FluxPriorReduxPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        image_latents = self.encode_image(image, 1)

        image_embeds = self.image_embedder(image_latents)[0]
