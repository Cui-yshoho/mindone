...
class StableAudioPipeline(DiffusionPipeline):
    ...
    def encode_duration(
        ...
        seconds_start_hidden_states = projection_output[1]
        seconds_end_hidden_states = projection_output[2]
    ...
    def prepare_latents(
        ...
        latents = (latents * self.scheduler.init_noise_sigma).to(latents.dtype)
        ...
        if initial_audio_waveforms is not None:
            ...
            if initial_audio_waveforms.shape[1] == 1 and audio_channels == 2:
                ...
                initial_audio_waveforms = initial_audio_waveforms.mean(1, keep_dims=True)
            ...
            encoded_audio = self.vae.diag_gauss_dist.sample(self.vae.encode(audio)[0])
