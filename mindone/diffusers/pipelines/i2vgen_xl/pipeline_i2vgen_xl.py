...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> negative_prompt = "Distorted, discontinuous, Ugly, blurry, low resolution, motionless, static, disfigured, disconnected limbs, Ugly faces, incomplete arms"  # noqa: E501
    ...
    r"""
     ...
     Args:
        frames (`ms.Tensor`, `np.ndarray`, or List[List[PIL.Image.Image]]):
            ...
            denoised
     PIL image sequences of length `num_frames.` It can also be a NumPy array or MindSpore tensor of shape
