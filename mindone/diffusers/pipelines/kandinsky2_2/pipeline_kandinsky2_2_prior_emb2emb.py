...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from mindone.diffusers import KandinskyV22Pipeline, KandinskyV22PriorEmb2EmbPipeline
        >>> import mindspore as ms
        ...
        ...     "/kandinsky/cat.png"
        ... )
        >>> image_emb, nagative_image_emb = pipe_prior(prompt, image=img, strength=0.2)
...
EXAMPLE_INTERPOLATE_DOC_STRING = """
    Examples:
        ```py
        >>> from mindone.diffusers import KandinskyV22PriorEmb2EmbPipeline, KandinskyV22Pipeline
