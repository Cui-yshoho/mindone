...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> pipe = Lumina2Pipeline.from_pretrained("Alpha-VLLM/Lumina-Image-2.0", mindspore_dtype=ms.bfloat16)
...
class Lumina2Text2ImgPipeline(Lumina2Pipeline):
    def __init__(
        ...
        deprecation_message = "`Lumina2Text2ImgPipeline` has been renamed to `Lumina2Pipeline` and will be removed in a future version. Please use `Lumina2Pipeline` instead."  # noqa
