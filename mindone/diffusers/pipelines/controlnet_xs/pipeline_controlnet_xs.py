...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from mindone.diffusers import StableDiffusionControlNetXSPipeline, ControlNetXSAdapter
        ...
        ...     "UmerHA/Testing-ConrolNetXS-SD2.1-canny", mindspore_dtype=mindspore.float16
        ... )
        >>> pipe = StableDiffusionControlNetXSPipeline.from_pretrained(
        ...     "stabilityai/stable-diffusion-2-1-base", controlnet=controlnet, mindspore_dtype=mindspore.float16
        ... )
