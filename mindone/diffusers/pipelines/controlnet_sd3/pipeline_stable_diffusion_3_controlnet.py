...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> controlnet = SD3ControlNetModel.from_pretrained("InstantX/SD3-Controlnet-Canny", mindspore_dtype=mindspore.float16)
...
class StableDiffusion3ControlNetPipeline(DiffusionPipeline, FromSingleFileMixin):
    r"""
    Args:
