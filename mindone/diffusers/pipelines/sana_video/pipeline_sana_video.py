...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> prompt = "Evening, backlight, side lighting, soft light, high contrast, mid-shot, centered composition, " \
                     "clean solo shot, warm color. A young Caucasian man stands in a forest, " \
                     "golden light glimmers on his hair as sunlight filters through the leaves. " \
                     "He wears a light shirt, wind gently blowing his hair and collar, " \
                     "light dances across his face with his movements. The background is blurred, " \
                     "with dappled light and soft tree shadows in the distance. " \
                     "The camera focuses on his lifted gaze, clear and emotional."
