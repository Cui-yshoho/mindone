...
from llava.mm_utils import expand2square, load_image_from_base64, process_images, tokenizer_image_token
...
if __name__ == "__main__":
    ...
    worker = ModelWorker(
        args.controller_address, args.worker_address, args.sgl_endpoint, worker_id, args.no_register, args.model_name
    )
