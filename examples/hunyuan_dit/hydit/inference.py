...
class End2End(object):
    ...
    def load_mindspore_weights(self):
        ...
        # model_state_dict = {k: v for k, v in self.model.parameters_and_names()}
        # expected_keys = list(model_state_dict.keys())
        # loaded_keys = [_get_pt2ms_mappings(self.model).get(k, (k, None))[0] for k in loaded_state_dict_keys]
