...
def get_args(default_args=None):
    ...
    parser.add_argument(
        "--use-style-cond", action="store_true", help="Use style condition in hydit. Only for hydit version <= 1.1"
    )
    parser.add_argument(
        "--size-cond",
        type=int,
    ...
    # Acceleration
    parser.add_argument(
        "--infer-mode", type=str, choices=["fa", "mindspore", "trt"], default="fa", help="Inference mode"
    )
